...
class ClientTab3CurrentAdapter extends RecyclerView.Adapter<ClientTab3CurrentAdapter.MyViewHolder>  {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            service_expier_date =(TextView) view.findViewById(R.id.service_expier_date);

        }

    }

    public ClientTab3CurrentAdapter(List<Order> ordersList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.client_tab2_reservation_list_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(order.getConfirmation().equals("NO")){
                    String value = order.getOrderID();
                    Intent i = new Intent(context, ClientOrderPage.class);
                    i.putExtra("orderID", value);
                    context.startActivity(i);
                }
                if(order.getConfirmation().equals("rejected")){
                    String value = order.getOrderID();
                    Intent i = new Intent(context, ClientRejectedPage.class);
                    i.putExtra("orderID", value);
                    context.startActivity(i);
                }
                if(order.getConfirmation().equals("YES")) {
                    String value = order.getOrderID();
