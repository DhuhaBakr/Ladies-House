...
class FreelancerTab3CurrentAdapter extends RecyclerView.Adapter<FreelancerTab3CurrentAdapter.MyViewHolder>  {
    ...
    public FreelancerTab3CurrentAdapter(List<Order> ordersList, Context context) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(order.getConfirmation().equals("NO") ){
                    ...
                    Intent i = new Intent(context, FreelancerConfirmOrder.class);
