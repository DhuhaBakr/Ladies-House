...
public class FreelancerTab1CustomAdapter extends BaseAdapter{
private Context mContext;
private List<FreelancerServices> freelancerServicesList;

    public FreelancerTab1CustomAdapter(Context mContext, List<FreelancerServices> freelancerServicesList) {
