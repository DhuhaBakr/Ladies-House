...
public  class ClientTab4Profile extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.client_tab4_profile, container, false);
        ...
        final DatabaseReference ClientDB = DB.child("Client").child(firebaseUser.getUid());
                 ...
                 client_phone_text.setEnabled(true);
                    ...
                    if(client_phone_text.getText() !=null) {
                        try {
                            ...
                            ClientDB.child("phone").setValue(client_phone_text.getText().toString());
